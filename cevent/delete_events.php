...
{
var agree=confirm("Are you sure that you want to delete the selected events?");
if (agree)
{
	alert("Selected events have been deleted !!!");
	return true ;
}
else
	return false ;
...
echo <<<disp
<form action="delevents.php" method="post" name="list" onsubmit="return confirmDelete()" >
<table width="100%">
<tr>
    <td><b>ID</b></td>
    <td><b>Name</b></td>
...
onClick="selectAll(document.list)">
  <input type="button" class="button" name="unselectall" value="Unselect All" 

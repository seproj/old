...
<p class="tp" style="font-size:18;font-color:#2E2E2E;">
  Upload a excel sheet which contains calendar of events in specified format 
</p>
<form name="input" action="uploader.php" method="post" enctype="multipart/form-data" onsubmit="return validateForm()">
<label for="file">Filename:</label>
<input type="file" accept="vnd.ms-excel" name="file" id="file" /> 
<br />
